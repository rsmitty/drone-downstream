...
#
# Generated on 2023-09-07T20:47:21Z by kres latest.
...
all: unit-tests drone-downstream image-drone-downstream lint
...
.PHONY: $(ARTIFACTS)/drone-downstream-linux-amd64
$(ARTIFACTS)/drone-downstream-linux-amd64:
	@$(MAKE) local-drone-downstream-linux-amd64 DEST=$(ARTIFACTS)

.PHONY: drone-downstream-linux-amd64
drone-downstream-linux-amd64: $(ARTIFACTS)/drone-downstream-linux-amd64  ## Builds executable for drone-downstream-linux-amd64.

.PHONY: $(ARTIFACTS)/drone-downstream-linux-arm64
$(ARTIFACTS)/drone-downstream-linux-arm64:
	@$(MAKE) local-drone-downstream-linux-arm64 DEST=$(ARTIFACTS)

.PHONY: drone-downstream-linux-arm64
drone-downstream-linux-arm64: $(ARTIFACTS)/drone-downstream-linux-arm64  ## Builds executable for drone-downstream-linux-arm64.

.PHONY: drone-downstream
drone-downstream: drone-downstream-linux-amd64 drone-downstream-linux-arm64  ## Builds executables for drone-downstream.
...
.PHONY: image-drone-downstream
image-drone-downstream:  ## Builds image for drone-downstream.
	@$(MAKE) target-$@ TARGET_ARGS="--tag=$(REGISTRY)/$(USERNAME)/drone-downstream:$(TAG)"
